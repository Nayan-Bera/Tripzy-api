...
const generaterandomDigit_1 = __importDefault(require("../utils/generaterandomDigit"));
const db_1 = __importDefault(require("../db"));
const schema_1 = require("../db/schema");
const transporter = nodemailer_1.default.createTransport({
    host: config_1.config.SMTP_HOST,
    port: Number(config_1.config.SMTP_PORT),
    secure: config_1.config.SMTP_SRC == 'true',
    auth: {
        user: config_1.config.SMTP_MAIL,
        pass: config_1.config.SMTP_PASSWORD,
    },
});
const emailOtpService = (_a, res_1, next_1) => __awaiter(void 0, [_a, res_1, next_1], void 0, function* ({ id, email }, res, next) {
    try {
        // generate otp
        const createOTP = (0, generaterandomDigit_1.default)(100000, 900000);
        // sent mail
        let sentEmail = {
	...
	<body>
        ...
        try {
            const val = yield db_1.default
                .insert(schema_1.otps)
                .values({
                userId: id,
...
exports.default = emailOtpService;
